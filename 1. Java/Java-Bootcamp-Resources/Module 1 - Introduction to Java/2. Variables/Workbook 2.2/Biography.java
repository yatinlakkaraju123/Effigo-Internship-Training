public class Biography {
    public static void main(String[] args) {
        ...
        String name = "Yatin";// name (text)
        int age = 21;// age (whole number)
        String country = "India";// country (text)
        String sport = "cricket";// sport (text)
        int hours = 11;// hours (whole number)
        String game = "quidich";// game (text)
        String subject = "english";// subject (text)
        char grade = 'A';// grade (character)
